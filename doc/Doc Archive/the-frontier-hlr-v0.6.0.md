# THE FRONTIER
## High-Level Requirements Document -- Version 0.6.0

**Companion to: GDD v9 | Godot 4 / GDScript / JSON**
**March 2026**
...
| ID | Requirement | Priority |
|---|---|---|
| INJ-001 | 7 injury types per GDD v9 Section 3. | MUST |
...
| SURV-004 | Stream water must be boiled at campfire or risk Gut Sickness. Waterskins no weight empty. Settlement wells clean. Alchemist purifies. | MUST |
...
| ID | Requirement | Priority |
|---|---|---|
| RUNE-001 | Rune slots per GDD v9 Section 4. | MUST |
...
| MON-002 | Inner safe zone around settlements. | MUST |
| MON-003 | Area suppression: TP ~25%, Village ~50%, Town ~75%, City 100%. | MUST |
...
| NAV-010 | Landmarks per GDD v9. Deep Water Ports = whales + seagulls. | MUST |
...
| CAMP-002 | Tent: required, purchased, weighted. | MUST |
...
| CAMP-007 | Abandon camp via menu (hirelings dismissed, items destroyed). | MUST |
...
| ID | Requirement | Priority |
|---|---|---|
| TIER-001 | 4 tiers per GDD v9. | MUST |
...
| DSYS-007 | All 28 launch abilities per GDD v9. Each in JSON. | MUST |
...
| ID | Requirement | Priority |
|---|---|---|
| CRAFT-001 | Food hierarchy per GDD v9 Section 10. Berries, fish, meat, rations, Hunter, settlement meals. | MUST |
| CRAFT-002 | Raw meat and unboiled water risk Gut Sickness. | MUST |
| CRAFT-003 | Cooking requires campfire kit + cooking kit. | MUST |
| CRAFT-004 | Rations: best hunger + half-day stamina regen + carry capacity buff. | MUST |
...
| SAVE-002 | State per GDD v9 Section 13 technical notes. | MUST |
