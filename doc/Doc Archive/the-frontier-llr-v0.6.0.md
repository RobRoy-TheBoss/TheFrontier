# THE FRONTIER
## Low-Level Requirements Document -- Version 0.6.0

**Traces to: HLR v0.6.0 | GDD v9**
...
| LCORE-015 | CORE-006 | The game shall present no main quest, no mandatory objectives, and no story gates that block exploration. | U |
| LCORE-016 | CORE-002 | The game shall target a minimum of 30 FPS on mid-range hardware. target_fps in project settings shall be set to 60 as the hard target. | U |
...
| LDATA-045 | DATA-001 | monsters.json shall contain at least 8 monster entries. | T |
...
| LMAP-062 | MAP-002 | areas.json shall contain between 200 and 300 area entries at launch. | T |
| LMAP-063 | MAP-011 | Each area entry shall have a difficulty field. Difficulty shall increase from west to east (higher q-coordinate = higher difficulty). | T |
| LMAP-064 | MAP-018 | Wild area traversal shall take approximately 3 minutes real time; empty area approximately 1 minute; full area exploration approximately 2-3 minutes. | U |
| LMAP-065 | MAP-009 | Deep Water Port areas shall have associated whale and seagull landmark entries in landmarks.json. | U |
...
| LMAP-035 | MAP-012 | [DELETED — duplicate of LMAP-025. ID reserved.] | DELETED |
...
| LPC-012 | PC-004 | When total inventory weight exceeds max_carry, SPRINT shall be disabled. | T |
| LPC-013 | PC-004 | When over-encumbered, WALK speed shall be multiplied by a configurable penalty. | T |
...
| LSURV-028 | SURV-005 | survival.json shall define sub-objects for hunger, thirst, temperature, and fatigue, each containing at least a warn/low threshold and a critical threshold. | T |
...
| LSPN-006 | MON-003 | settlement_tiers.json shall define suppression_pct per tier: tier 1 = 0.25, tier 2 = 0.50, tier 3 = 0.75, tier 4 = 1.00. | T |
...
| LNAV-055 | NAV-003 | The game shall not include a minimap widget on the HUD or any screen. | U |
| LNAV-056 | NAV-003 | The game shall not display waypoints, objective markers, or directional indicators toward any quest target. | U |
...
| LSCORE-011 | GROW-004 | When a settlement's Dijkstra route to port passes through a junction node already used by a higher-trade-score settlement's route, the existing route shall not be displaced. Dijkstra on the road topology graph provides natural first-mover advantage. | T |
...
| LALC-A10 | DSYS-007 | Alchemist shall be able to purify unboiled water (removes Gut Sickness risk without campfire boiling). | T |
...
| LCRAFT-009 | CRAFT-002 | Food items with a spoil_timer shall tick down over time. | T |
| LCRAFT-010 | CRAFT-002 | Eating expired food shall trigger a Gut Sickness probability roll. | T |
...
| LCRAFT-023 | CRAFT-001 | Fish shall be catchable with a fishing rod at water bodies. | T |
| LCRAFT-024 | CRAFT-001 | Fish shall require cooking before eating (raw fish = Gut Sickness roll). | T |
| LCRAFT-025 | CRAFT-002 | Cooked meat and fish shall spoil in approximately 2 in-game days. | T |
| LCRAFT-026 | CRAFT-008 | All recipes shall be defined in JSON. | T |
| LCRAFT-027 | CAMP-003 | A campfire_kit recipe shall exist in recipes.json with wood (or wood-equivalent item) as a required ingredient. | T |
| LCRAFT-028 | CRAFT-005 | Cooked meat and cooked fish items shall have a positive spoil_timer value in items.json. | T |
